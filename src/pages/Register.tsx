...
interface RegisterProps {
  onSuccess: () => void;
  onSwitchToLogin: (defaultRole?: UserRole) => void;
  onCancel?: () => void;
      ...
      <div className="w-full max-w-lg space-y-4">
        ...
        >
          ...
          >
            ...
            <span className="text-[9px] opacity-80">SOS & Medical</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] opacity-80">Safe Zones</span>
          </button>
        ...
        {/* Dedicated Individual Role Register Views */}
        <div className="transition-all duration-300">
          {selectedRole === 'girl' && (
            <GirlRegisterView
              onSuccess={onSuccess}
              onSwitchToLogin={() => onSwitchToLogin('girl')}
          ...
          {selectedRole === 'parent' && (
            <ParentRegisterView
              onSuccess={onSuccess}
              onSwitchToLogin={() => onSwitchToLogin('parent')}
              onSwitchRole={handleRoleChange}
              onCancel={onCancel}
              showCancelButton={Boolean(onCancel)}
            />
          ...
          {selectedRole === 'admin' && (
            <AdminRegisterView
              onSuccess={onSuccess}
              onSwitchToLogin={() => onSwitchToLogin('admin')}
              onSwitchRole={handleRoleChange}
              onCancel={onCancel}
              showCancelButton={Boolean(onCancel)}
            />
